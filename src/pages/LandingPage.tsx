...
const LandingPage: React.FC<LandingPageProps> = ({ darkMode, toggleDarkMode }) => {
  ...
  const features = [
    { icon: <Zap className="h-8 w-8" />, title: 'No Coding Required', description: 'Launch your token without writing a single line of code' },
    { icon: <Rocket className="h-8 w-8" />, title: 'Instant Deployment', description: 'Deploy your token in minutes with our streamlined process' },
    { icon: <Shield className="h-8 w-8" />, title: 'Secure & Audited', description: 'Built on battle-tested smart contracts with security first' }
  ]

  const steps = [
    { number: '1', title: 'Connect Your Wallet', description: 'Connect your Web3 wallet to get started' },
    { number: '2', title: 'Configure Your Token', description: 'Set your token name, symbol, supply, and other parameters' },
    { number: '3', title: 'Deploy & Launch', description: 'Deploy your token with one click and start building your community' }
  ]
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              ...
              <Button asChild variant="outline" size="lg" className="text-lg px-8 py-6">
                <Link to="/launch">Launch Your Token</Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <section id="how-it-works" ref={howItWorksRef} className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 observe-me">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">Simple three-step process to launch your token</p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-muted-foreground text-sm">© 2025 TokenLaunch. All rights reserved.</p>
            </div>
