...
import { Rocket, Copy, ExternalLink, Eye, EyeOff, CheckCircle, XCircle, Search, Filter, RefreshCw } from 'lucide-react';
...
const TokenLauncher: React.FC = () => {
    ...
    const loadTokens = async () => {
        setIsLoading(true);
        try {
            const tokens = await getAllLaunchedTokens();
    ...
    const handleDeploy = async () => {
        ...
        try {
            ...
            const contract = new ethers.Contract(TOKEN_LAUNCHER_CONTRACT.address, TOKEN_LAUNCHER_CONTRACT.abi, signer);
            ...
            // Refresh tokens after successful deployment
            await loadTokens();
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <Button
                                    ...
                                    disabled={!agreedToTerms || isDeploying || !formData.name || !formData.symbol || !formData.description || !formData.imageUrl || !formData.supply}
                                >
                                    {isDeploying ? (
                                        <>
                            ...
                            <CardHeader>
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                    <div>
                                        ...
                                        <CardDescription>
                                            Tokens created on Celo Alfajores
                                        </CardDescription>
                                    </div>
